...
class ConflictResolutionStrategy {
    ...
    fun hasConflict(localEvent: EventEntity, remoteEvent: RemoteEventDto): Boolean {
...
private fun RemoteEventDto.toEventEntity(localId: Long): EventEntity {
    return EventEntity(
        id = localId,
        type = com.dpconde.sofiatracker.domain.model.EventType.valueOf(this.type),
